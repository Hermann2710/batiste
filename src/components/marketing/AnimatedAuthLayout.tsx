...
export default function AnimatedAuthLayout({
  ...
  return (
    <main className="flex min-h-screen">
      <div
        ref={leftRef}
        className="flex w-full flex-col justify-center bg-[#f7f7f5] px-6 py-12 sm:px-12 lg:w-1/2"
      >
        {left}
      </div>
      <div
        ref={rightRef}
        className="dashboard-grid relative hidden overflow-hidden bg-zinc-950 lg:block lg:w-1/2"
      >
